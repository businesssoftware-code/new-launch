...
const RootLayout: React.FC<RootLayoutProps> = ({
  ...
  return (
    <div
      id="drawer-container"
      className={`fixed bottom-0 left-0 w-full bg-white rounded-t-[40px] shadow-lg transition-all duration-500 ease-in-out
        ${isExpanded ? "h-[90vh]" : "h-[70vh]"} max-h-[90vh] overflow-y-auto`}
    >
      {/* Sticky Header */}
      <div className="sticky top-0 bg-white z-10 p-4">
        <div
          className="w-[20%] h-1 bg-[#E9E9E9] mx-auto rounded-full mb-4 cursor-pointer"
